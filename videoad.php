...
<head>
    ...
    <title>video ad design</title>
</head>
<body>     
     <?php require 'parials/_nav.php'?>
        <center> <img src="img/video.png" width="300px" style="margin-top: 10px;"></center>
        <p style="    font-family: 'Roboto Condensed', sans-serif; display: block; align-items: center; text-align: center; margin: 68px;  font-size: 20px;     color: wheat; " >
         HELLO, AS YOUR REWQUIREMENT WE PROVIDE YOUR VIDEO AD  PLEASE FILL THE FORM CAREFULLY...!
        </p>
